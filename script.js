  ...
  const lightbox = Vue.component("lightbox", {
    ...
    methods: {
      ...
      getFullPhotos: function(variant) {
        ...
        this.productInfo.image_groups.map(groups => {
          if (
            groups.view_type == "hi-res" &&
            groups.variation_value == variant
          ) {
  ...
  var myApp = new Vue({
    ...
    template: ` <div>
                ...
                <div class="resultsWrapper">
                  ...
                  <div v-if="errorFlag == true" class="alterText"> We couldn't load any results :( Sorry!</div>
